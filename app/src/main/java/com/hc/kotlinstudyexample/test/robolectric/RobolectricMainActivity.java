package com.hc.kotlinstudyexample.test.robolectric;
 ...
 * all rights reserved
 */
public class RobolectricMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.robolectric_activity_main);
        lifecycle = "onCreate";
